...
const CMS_CONTENT = [
  {
    ...
    body: [
      ...
      '<h2>Tracking</h2>',
      '<p>As soon as your parcel leaves our warehouse we email a tracking number. You can also follow it from <a href="/account/orders">your orders</a>.</p>',
      '<h2>Where we ship</h2>',
  ...
  },
  {
    ...
    body: [
      ...
      '<ol><li>Open the order in <a href="/account/orders">your orders</a>.</li><li>Choose the items you want to send back and the reason.</li><li>Print the label we email you and hand the parcel to the carrier.</li></ol>',
      '<h2>Refunds</h2>',
