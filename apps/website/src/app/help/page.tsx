      ...
      <div className='mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='mt-2 text-xs font-medium uppercase tracking-wider text-stone-400'>
            Demo help modules — replace with CMS/API later
          </p>
        </motion.div>

        <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
          {DEMO_HELP_TOPICS.map((topic, index) => {
        ...
        <section className='mt-12 grid gap-6 lg:grid-cols-2'>
          <div className='rounded-2xl border border-stone-200 bg-white p-6 sm:p-8'>
            <div className='inline-flex items-center gap-2 text-sm font-extrabold text-stone-900'>
              <HelpCircle className='h-5 w-5 text-fuchsia-700' aria-hidden />
              Quick answers
            </div>
            <ul className='mt-4 space-y-3 text-sm font-semibold text-stone-600'>
              <li>
                <Link href='/faq' className='text-fuchsia-700 hover:underline'>
                  FAQ
                </Link>{' '}
